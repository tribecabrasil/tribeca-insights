...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("base_url", type=str, help="Base URL to start crawling (e.g., https://example.com)")
        parser.add_argument("--max-pages", type=int, default=100, help="Maximum number of pages to crawl")
        parser.add_argument("--language", type=str, default="en", help="Language for stopword filtering (e.g., en, pt-br)")
